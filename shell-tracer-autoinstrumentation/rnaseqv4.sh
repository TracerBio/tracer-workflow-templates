...
# Run the R script for edgeR analysis
Rscript - <<EOF
...
write.table(res, file = "edger_results.tsv", sep = "\t", row.names = TRUE, quote = FALSE)

EOF

echo "Analysis completed. edgeR results saved to edger_results.tsv."