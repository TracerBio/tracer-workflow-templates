...
STAR --runThreadN 4 --runMode genomeGenerate --genomeDir ./mouse_genome --genomeSAindexNbases 10 --genomeFastaFiles mus.fa --sjdbGTFfile hg19.refGene.gtf --sjdbOverhang 99;
...
STAR --runThreadN 4 --genomeDir ./mouse_genome --readFilesIn s1_1.fq s1_2.fq --outFileNamePrefix P1s1 --outSAMtype BAM SortedByCoordinate;
